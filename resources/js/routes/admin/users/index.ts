 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/admin/users/{user}/toggle-status'
 */
...
toggleStatus.definition = {
    methods: ["post"],
    url: 'https://mediflow-production-60a9.up.railway.app/admin/users/{user}/toggle-status',
