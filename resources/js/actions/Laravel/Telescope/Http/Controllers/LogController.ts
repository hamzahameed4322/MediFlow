 ...
 * @route 'http://cms.test/telescope/telescope-api/logs'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/logs',
 ...
 * @route 'http://cms.test/telescope/telescope-api/logs/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/logs/{telescopeEntryId}',
