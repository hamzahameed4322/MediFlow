 ...
 * @route 'http://localhost/telescope/telescope-api/logs'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/logs',
 ...
 * @route 'http://localhost/telescope/telescope-api/logs/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/logs/{telescopeEntryId}',
