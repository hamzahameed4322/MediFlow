 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/logs'
 */
...
index.definition = {
    methods: ["post"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/logs',
 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/logs/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/logs/{telescopeEntryId}',
