 ...
 * @route 'http://localhost/telescope/telescope-api/queries'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/queries',
 ...
 * @route 'http://localhost/telescope/telescope-api/queries/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/queries/{telescopeEntryId}',
