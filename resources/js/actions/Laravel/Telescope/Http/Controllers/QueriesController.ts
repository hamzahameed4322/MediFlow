 ...
 * @route 'http://cms.test/telescope/telescope-api/queries'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/queries',
 ...
 * @route 'http://cms.test/telescope/telescope-api/queries/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/queries/{telescopeEntryId}',
