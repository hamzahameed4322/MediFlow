 ...
 * @route 'http://localhost/telescope/telescope-api/commands'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/commands',
 ...
 * @route 'http://localhost/telescope/telescope-api/commands/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/commands/{telescopeEntryId}',
