 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/commands'
 */
...
index.definition = {
    methods: ["post"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/commands',
 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/commands/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/commands/{telescopeEntryId}',
