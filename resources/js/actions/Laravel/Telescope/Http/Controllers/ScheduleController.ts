 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/schedule'
 */
...
index.definition = {
    methods: ["post"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/schedule',
 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/schedule/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/schedule/{telescopeEntryId}',
