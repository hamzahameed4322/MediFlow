 ...
 * @route 'http://cms.test/telescope/telescope-api/schedule'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/schedule',
 ...
 * @route 'http://cms.test/telescope/telescope-api/schedule/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/schedule/{telescopeEntryId}',
