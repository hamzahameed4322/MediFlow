 ...
 * @route 'http://localhost/telescope/telescope-api/schedule'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/schedule',
 ...
 * @route 'http://localhost/telescope/telescope-api/schedule/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/schedule/{telescopeEntryId}',
