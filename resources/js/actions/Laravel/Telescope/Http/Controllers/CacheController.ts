 ...
 * @route 'http://cms.test/telescope/telescope-api/cache'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/cache',
 ...
 * @route 'http://cms.test/telescope/telescope-api/cache/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/cache/{telescopeEntryId}',
