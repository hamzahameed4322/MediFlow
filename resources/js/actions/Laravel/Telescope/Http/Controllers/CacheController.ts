 ...
 * @route 'http://localhost/telescope/telescope-api/cache'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/cache',
 ...
 * @route 'http://localhost/telescope/telescope-api/cache/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/cache/{telescopeEntryId}',
