 ...
 * @route 'http://localhost/telescope/telescope-api/views'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/views',
 ...
 * @route 'http://localhost/telescope/telescope-api/views/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/views/{telescopeEntryId}',
