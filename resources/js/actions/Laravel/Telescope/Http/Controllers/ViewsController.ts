 ...
 * @route 'http://cms.test/telescope/telescope-api/views'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/views',
 ...
 * @route 'http://cms.test/telescope/telescope-api/views/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/views/{telescopeEntryId}',
