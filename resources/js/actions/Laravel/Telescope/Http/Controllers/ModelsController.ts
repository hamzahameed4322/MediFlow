 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/models'
 */
...
index.definition = {
    methods: ["post"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/models',
 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/models/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/models/{telescopeEntryId}',
