 ...
 * @route 'http://localhost/telescope/telescope-api/models'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/models',
 ...
 * @route 'http://localhost/telescope/telescope-api/models/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/models/{telescopeEntryId}',
