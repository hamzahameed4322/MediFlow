 ...
 * @route 'http://cms.test/telescope/telescope-api/models'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/models',
 ...
 * @route 'http://cms.test/telescope/telescope-api/models/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/models/{telescopeEntryId}',
