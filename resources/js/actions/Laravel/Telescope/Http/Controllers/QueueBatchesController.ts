 ...
 * @route 'http://localhost/telescope/telescope-api/batches'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/batches',
 ...
 * @route 'http://localhost/telescope/telescope-api/batches/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/batches/{telescopeEntryId}',
