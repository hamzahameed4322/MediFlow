 ...
 * @route 'http://cms.test/telescope/telescope-api/client-requests'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/client-requests',
 ...
 * @route 'http://cms.test/telescope/telescope-api/client-requests/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/client-requests/{telescopeEntryId}',
