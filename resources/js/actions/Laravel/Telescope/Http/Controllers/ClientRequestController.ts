 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/client-requests'
 */
...
index.definition = {
    methods: ["post"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/client-requests',
 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/client-requests/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/client-requests/{telescopeEntryId}',
