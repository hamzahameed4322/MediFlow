 ...
 * @route 'http://localhost/telescope/telescope-api/client-requests'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/client-requests',
 ...
 * @route 'http://localhost/telescope/telescope-api/client-requests/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/client-requests/{telescopeEntryId}',
