 ...
 * @route 'http://localhost/telescope/telescope-api/requests'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/requests',
 ...
 * @route 'http://localhost/telescope/telescope-api/requests/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/requests/{telescopeEntryId}',
