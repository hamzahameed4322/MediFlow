 ...
 * @route 'http://cms.test/telescope/telescope-api/requests'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/requests',
 ...
 * @route 'http://cms.test/telescope/telescope-api/requests/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/requests/{telescopeEntryId}',
