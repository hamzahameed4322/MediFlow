 ...
 * @route 'http://localhost/telescope/telescope-api/exceptions'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/exceptions',
 ...
 * @route 'http://localhost/telescope/telescope-api/exceptions/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/exceptions/{telescopeEntryId}',
