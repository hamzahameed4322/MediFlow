 ...
 * @route 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/entries'
 */
...
destroy.definition = {
    methods: ["delete"],
    url: 'https://mediflow-production-60a9.up.railway.app/telescope/telescope-api/entries',
