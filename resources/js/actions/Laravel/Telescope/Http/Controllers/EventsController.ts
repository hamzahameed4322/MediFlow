 ...
 * @route 'http://localhost/telescope/telescope-api/events'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/events',
 ...
 * @route 'http://localhost/telescope/telescope-api/events/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/events/{telescopeEntryId}',
