 ...
 * @route 'http://cms.test/telescope/telescope-api/events'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://cms.test/telescope/telescope-api/events',
 ...
 * @route 'http://cms.test/telescope/telescope-api/events/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://cms.test/telescope/telescope-api/events/{telescopeEntryId}',
