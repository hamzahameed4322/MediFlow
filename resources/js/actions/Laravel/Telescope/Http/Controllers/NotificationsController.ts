 ...
 * @route 'http://localhost/telescope/telescope-api/notifications'
 */
...
index.definition = {
    methods: ["post"],
    url: 'http://localhost/telescope/telescope-api/notifications',
 ...
 * @route 'http://localhost/telescope/telescope-api/notifications/{telescopeEntryId}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: 'http://localhost/telescope/telescope-api/notifications/{telescopeEntryId}',
